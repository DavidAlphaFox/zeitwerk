...
class TestUnregister < LoaderTest
  test "unregister removes the loader from internal state" do
    ...
    Zeitwerk::ExplicitNamespace.__register(Zeitwerk::Cref.new(Object, :dummy1), loader1)
    ...
    assert !Zeitwerk::ExplicitNamespace.__registered?(Object, :dummy1)
    ...
    assert Zeitwerk::ExplicitNamespace.__registered?(Object, :dummy2) == loader2
  end
