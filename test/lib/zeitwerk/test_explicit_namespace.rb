...
class TestExplicitNamespace < LoaderTest
  ...
  test "namespace promotion updates the registry" do
    ...
    with_setup(files) do
      assert_nil Zeitwerk::Registry::Autoloads.loader_for(File.expand_path("rd1/m"))
      assert_same loader, Zeitwerk::Registry::Autoloads.loader_for(File.expand_path("rd2/m.rb"))
    end
  end
